...
{
    public partial class DSTienDienScreen : Form
    {
        SqlConnection Conn;
        SqlCommand command;
        SqlDataAdapter adapter = new SqlDataAdapter();
        public DSTienDienScreen()
        {
            InitializeComponent();
        }

        private void DSTienDienScreen_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                string sql = "select * from ElecDevice";
