...
{
    public partial class DSTienNuocScreen : Form
    {
        SqlConnection Conn;
        SqlCommand command;
        SqlDataAdapter adapter = new SqlDataAdapter();
       
        public DSTienNuocScreen()
        {
            InitializeComponent();
        }

        private void DSTienNuocScreen_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                string sql = "select * from waterPay";
